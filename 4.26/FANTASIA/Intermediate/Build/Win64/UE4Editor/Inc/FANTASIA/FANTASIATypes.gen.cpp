...
static struct FScriptStruct_FANTASIA_StaticRegisterNativesFNLUResponse
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("NLUResponse")),new UScriptStruct::TCppStructOps<FNLUResponse>);
	}
...
static struct FScriptStruct_FANTASIA_StaticRegisterNativesFNeo4jResponse
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("Neo4jResponse")),new UScriptStruct::TCppStructOps<FNeo4jResponse>);
	}
...
static struct FScriptStruct_FANTASIA_StaticRegisterNativesFTTSData
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("TTSData")),new UScriptStruct::TCppStructOps<FTTSData>);
	}
...
static struct FScriptStruct_FANTASIA_StaticRegisterNativesFTTSTimedStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("TTSTimedStruct")),new UScriptStruct::TCppStructOps<FTTSTimedStruct>);
	}
