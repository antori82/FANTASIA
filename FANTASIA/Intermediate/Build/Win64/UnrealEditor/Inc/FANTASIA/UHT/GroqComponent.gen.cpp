...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UGroqComponent_getGPTCompletion_Statics::NewProp_messages = { "messages", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(GroqComponent_eventgetGPTCompletion_Parms, messages), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 1111787146
...
FClassRegistrationInfo Z_Registration_Info_UClass_UGroqComponent;
UClass* UGroqComponent::GetPrivateStaticClass()
{
	using TClass = UGroqComponent;
	if (!Z_Registration_Info_UClass_UGroqComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("GroqComponent"),
			Z_Registration_Info_UClass_UGroqComponent.InnerSingleton,
			StaticRegisterNativesUGroqComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UGroqComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UGroqComponent_NoRegister()
{
	return UGroqComponent::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UGroqComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGroqComponent_getGPTCompletion, "getGPTCompletion" }, // 1017711516
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_GroqComponent_h__Script_FANTASIA_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGroqComponent, UGroqComponent::StaticClass, TEXT("UGroqComponent"), &Z_Registration_Info_UClass_UGroqComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGroqComponent), 2553115866U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_GroqComponent_h__Script_FANTASIA_1427869782(TEXT("/Script/FANTASIA"),
	Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_GroqComponent_h__Script_FANTASIA_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_GroqComponent_h__Script_FANTASIA_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
