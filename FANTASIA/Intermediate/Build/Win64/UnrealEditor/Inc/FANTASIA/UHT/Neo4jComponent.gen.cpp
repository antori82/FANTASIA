...
UFunction* Z_Construct_UDelegateFunction_FANTASIA_IncomingNeo4jResponseEvent__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_FANTASIA_IncomingNeo4jResponseEvent__DelegateSignature_Statics::FuncParams);
	}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UNeo4jComponent;
UClass* UNeo4jComponent::GetPrivateStaticClass()
{
	using TClass = UNeo4jComponent;
	if (!Z_Registration_Info_UClass_UNeo4jComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("Neo4jComponent"),
			Z_Registration_Info_UClass_UNeo4jComponent.InnerSingleton,
			StaticRegisterNativesUNeo4jComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UNeo4jComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UNeo4jComponent_NoRegister()
{
	return UNeo4jComponent::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UNeo4jComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNeo4jComponent_submitQuery, "submitQuery" }, // 1975536603
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_Neo4jComponent_h__Script_FANTASIA_4028682527(TEXT("/Script/FANTASIA"),
