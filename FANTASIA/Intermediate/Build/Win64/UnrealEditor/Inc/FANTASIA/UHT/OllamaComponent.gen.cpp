...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::NewProp_messages_Inner = { "messages", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FChatTurn, METADATA_PARAMS(0, nullptr) }; // 1111787146
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::NewProp_messages = { "messages", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OllamaComponent_eventgetGPTCompletion_Parms, messages), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 1111787146
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UOllamaComponent, nullptr, "getGPTCompletion", Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::PropPointers), sizeof(Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::OllamaComponent_eventgetGPTCompletion_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::Function_MetaDataParams), Z_Construct_UFunction_UOllamaComponent_getGPTCompletion_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UOllamaComponent;
UClass* UOllamaComponent::GetPrivateStaticClass()
{
	using TClass = UOllamaComponent;
	if (!Z_Registration_Info_UClass_UOllamaComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("OllamaComponent"),
			Z_Registration_Info_UClass_UOllamaComponent.InnerSingleton,
			StaticRegisterNativesUOllamaComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UOllamaComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UOllamaComponent_NoRegister()
{
	return UOllamaComponent::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UOllamaComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UOllamaComponent_getGPTCompletion, "getGPTCompletion" }, // 3455546860
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_OllamaComponent_h__Script_FANTASIA_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOllamaComponent, UOllamaComponent::StaticClass, TEXT("UOllamaComponent"), &Z_Registration_Info_UClass_UOllamaComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOllamaComponent), 2123541829U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_OllamaComponent_h__Script_FANTASIA_131605490(TEXT("/Script/FANTASIA"),
	Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_OllamaComponent_h__Script_FANTASIA_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_FANTASIADevelopment_Plugins_FANTASIA_FANTASIA_Source_FANTASIA_Public_OllamaComponent_h__Script_FANTASIA_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
