...
ElevenLabsTTSThread::ElevenLabsTTSThread(FString inKey, FString inVoiceID, FString inModelID, float inStability, float inSimilarity_boost, float inStyle, bool inUse_speaker_boost, bool stream) : StopTaskCounter(0) {
	key = inKey;
	voiceID = inVoiceID;
	modelID = inModelID;
