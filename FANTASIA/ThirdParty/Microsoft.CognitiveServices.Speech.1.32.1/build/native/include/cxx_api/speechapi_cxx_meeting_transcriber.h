...
private:
    ...
    {
        return [=, this](const EventSignal<const MeetingTranscriptionEventArgs&>& recoEvent) { this->RecoEventConnectionsChanged(recoEvent); };
    }
    ...
    {
        return [=, this](const EventSignal<const MeetingTranscriptionCanceledEventArgs&>& recoEvent) { this->RecoCanceledEventConnectionsChanged(recoEvent); };
    }
