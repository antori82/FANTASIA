...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_FANTASIA_IncomingNeo4jResponseEvent__DelegateSignature_Statics::NewProp_Neo4jResponse = { "Neo4jResponse", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_FANTASIA_eventIncomingNeo4jResponseEvent_Parms, Neo4jResponse), Z_Construct_UScriptStruct_FNeo4jResponse, METADATA_PARAMS(nullptr, 0) }; // 2831407371
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UNeo4jComponent_submitQuery_Statics::NewProp_query = { "query", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Neo4jComponent_eventsubmitQuery_Parms, query), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UNeo4jComponent_submitQuery_Statics::NewProp_operation_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UNeo4jComponent_submitQuery_Statics::NewProp_operation = { "operation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Neo4jComponent_eventsubmitQuery_Parms, operation), Z_Construct_UEnum_FANTASIA_Neo4jOperation, METADATA_PARAMS(nullptr, 0) }; // 2833991128
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UNeo4jComponent_submitQuery_Statics::NewProp_transactionID = { "transactionID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Neo4jComponent_eventsubmitQuery_Parms, transactionID), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UNeo4jComponent_submitQuery_Statics::NewProp_parameters_ValueProp = { "parameters", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UNeo4jComponent_submitQuery_Statics::NewProp_parameters_Key_KeyProp = { "parameters_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UFunction_UNeo4jComponent_submitQuery_Statics::NewProp_parameters = { "parameters", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Neo4jComponent_eventsubmitQuery_Parms, parameters), EMapPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNeo4jComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNeo4jComponent_submitQuery, "submitQuery" }, // 2093247992
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UNeo4jComponent_Statics::NewProp_IncomingResponse = { "IncomingResponse", nullptr, (EPropertyFlags)0x0010100010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNeo4jComponent, IncomingResponse), Z_Construct_UDelegateFunction_FANTASIA_IncomingNeo4jResponseEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UNeo4jComponent_Statics::NewProp_IncomingResponse_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNeo4jComponent_Statics::NewProp_IncomingResponse_MetaData)) }; // 3047835912
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNeo4jComponent_Statics::NewProp_response = { "response", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNeo4jComponent, response), METADATA_PARAMS(Z_Construct_UClass_UNeo4jComponent_Statics::NewProp_response_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNeo4jComponent_Statics::NewProp_response_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_Neo4jComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_Neo4jComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNeo4jComponent, UNeo4jComponent::StaticClass, TEXT("UNeo4jComponent"), &Z_Registration_Info_UClass_UNeo4jComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNeo4jComponent), 1894729744U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_Neo4jComponent_h_3299352925(TEXT("/Script/FANTASIA"),
		Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_Neo4jComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_Neo4jComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
