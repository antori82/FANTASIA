...
template<> FANTASIA_API UScriptStruct* StaticStruct<FparamValues>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FparamValues_Statics::NewProp_values_Inner = { "values", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FparamValues_Statics::NewProp_values = { "values", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FparamValues, values), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FparamValues_Statics::NewProp_values_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FparamValues_Statics::NewProp_values_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics::ScriptStructInfo[] = {
		{ FparamValues::StaticStruct, Z_Construct_UScriptStruct_FparamValues_Statics::NewStructOps, TEXT("paramValues"), &Z_Registration_Info_UScriptStruct_paramValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FparamValues), 1880320412U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_62958470(TEXT("/Script/FANTASIA"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Jason_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics::ScriptStructInfo),
		nullptr, 0);
